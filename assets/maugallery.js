(function($) {
  ...
  $.fn.mauGallery.methods = {
      ...
      showItemTags(gallery, position, tags) {
          var tagItems = '<li class="nav-item"><span class="nav-link active active-tag"  data-images-toggle="all" style="cursor:pointer">Tous</span></li>';
          $.each(tags, function(index, value) {
              tagItems += `<li class="nav-item active">
              <span class="nav-link"  data-images-toggle="${value}" style="cursor:pointer">${value}</span></li>`
          });
